...
(function(root, factory) {
    ...
    Pageable.prototype._drag = function(e) {
        if (this.config.freeScroll && this.dragging && !this.scrolling) {
            ...
            this.pages[this.index].style.transform = this.horizontal ? "translate3d(" + scrolled + "px, 0, 0)" : "translate3d(0, " + scrolled + "px, 0)";
    ...
    Pageable.prototype._scrollBy = function(amount, index) {
        ...
        that.timer = setTimeout(function() {
            ...
            var scroll = function scroll() {
                ...
                console.log(`scroll (${offset[that.axis]}): ${scrolled} -> ${that.scrollPosition}`)
                that.pages[0].style.transform = that.horizontal ? "translate3d(" + scrolled + "px, 0, 0)" : "translate3d(0, " + scrolled + "px, 0)";
    ...
    Pageable.prototype._getScrollAmount = function(oldIndex, newIndex) {
        ...
        var a = h * oldIndex;
        var b = h * newIndex;
        console.log(`${oldIndex} (${a}) -> ${newIndex} (${b})`)
        return a - b;
    };
